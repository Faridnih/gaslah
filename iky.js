...
const Bfake = fs.readFileSync ('./media/image/fake.jpeg','base64')
       ...
       const timeWib = moment.tz('Asia/Jakarta').format('DD/MM HH:mm:ss')
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = ikyy.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","listType": "SINGLE_SELECT","sections": list}},{quoted :mek})
...
//===============FAKEREPLY FARID====================
        ...
        const ftroli = {
         key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {orderMessage: {itemCount : 2021,status: 1,surface : 1,message: `🍂𝑰𝒕𝒔𝑴𝒆 𝑭 𝑨 𝑹 𝒁🍂\n𝑪𝒐𝒎𝒎𝒂𝒏𝒅 𝑬𝒙𝒆𝒄𝒖𝒕𝒆𝒅 : ${command}`,orderTitle: 'Bang',thumbnail: fs.readFileSync('./media/Nakano.jpg'), sellerJid: '0@s.whatsapp.net'}}}
        const ftoko = { 
...
//=========================FAKE REPLY======================
       ...
       const sendKontak = (from, nomor, nama, org = "") => {
	       ...
	       ikyy.sendMessage(from, {displayname: nama, vcard: vcard}, MessageType.contact, {quoted: fgc})
}
      ...
      const sendWebp = async(to, url) => {
           ...
           ikyy.sendMessage(from, fs.readFileSync(asw), sticker, {sendEphemeral:true, quoted:fgc})
           fs.unlinkSync(asw)
});
});
});
       ...
       const sendMediaURL = async(to, url, text="", mids=[]) =>{
           ...
           ikyy.sendMessage(to, media, type, {quoted: fgc, mimetype: mime, caption: text, thumbnail: Buffer.alloc(0), contextInfo: {"mentionedJid": mids}})
      ...
      mentions(cptl, x, true)
       ...
       // CMD
        ...
        case 'creator':
               ...
               buttons = [{buttonId: '!sourcecode',buttonText:{displayText: 'SC BOT'},type:1},{buttonId:'!infoig',buttonText:{displayText:'INSTAGRAM'},type:1},{buttonId: `${prefix}rules`, buttonText: {displayText: 'INFO🔎'}, type: 1},]
...
ikyy.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
        ...
        case 'help':
              ...
              gas = `https://telegra.ph/file/194a0b5963c1c5705d795.jpg`
              
        menu =` 𝑯𝑬𝑳𝑳𝑶𝑾𝑶𝑹𝑳𝑫👋🏻
       
㉺ INFO BOT 🔎
⸙ _Creator :_ ${ownerName}
⸙ _Hit Today :_ _${totalhit} Hit_
⸙ _User :_ _${isOwner ? 'OWNER' : isPremium ? 'Premium' : 'User'}_
⸙ _Status_ : _Online_
⸙ _Lib_ : _Baileys_
⸙ _Type_ : _NodeJs_
⸙ _Prefix_ : _「 Multi Prefix 」_
⸙ _Baterai_ : _${baterai}% ${charger}_
⸙ _Platform_ : _${os.platform()}_
⸙ _Group Chats_ : _${groups.length}_
⸙ _Private Chats_ : _${privat.length}_
⸙ _Total Chats_ : _${totalChat.length}_
⸙ _Time :_ _${jam} Wib_
⸙ _Speed_ : _${latensie.toFixed(4)} Second_
⸙ _Active_ : _${runtime(process.uptime())}_
...
`        
  ...
  {buttonId: `${prefix}owner`, buttonText: {displayText: '♔ OWNER'}, type: 1},
               ...
               imageMsg = (await ikyy.prepareMessageMedia(fs.readFileSync(`./media/Menu.jpeg`), 'imageMessage', { thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true }})).imageMessage

               buttonsMessage = {
               contentText: `${menu}`,
               footerText:  `   
ø${tanggal}                             `, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: fgc, contextInfo: { mentionedJid: [sender],externalAdReply: { "title": `${ucapanWaktu} Kak ${pushname}👋🏻`, mediaType: 2, "thumbnailUrl": `https://telegra.ph/file/1ff9b18cea4ce59490a54.jpg`, "mediaUrl": `https://youtu.be/dhYOPzcsbGM`}}})
              ...
              ikyy.relayWAMessage(prep)
               ...
               case 'groupmenu':
        case 'menugroup':
        ikyy.sendMessage(from, groupMenu(prefix), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
        break
             groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
              privat = ikyy.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
              ram2 = `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB`
...
❦ ${prefix}hidetag *teks/reply teks*
 `
               ...
               buttons =  [
    {buttonId: `${prefix}ping`, buttonText: {displayText: '☘️𝐒𝐩𝐞𝐞𝐝 𝐑𝐮𝐧☘️'}, type: 1},
]
...
🌹𝑰𝒕𝒔 𝑴𝒆 𝑭𝒂𝒓𝒊𝒅🌹`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
        ...
        case 'ownermenu':
        case  'menuowner':
        ikyy.sendMessage(from, ownerMenu(prefix), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
        break
              groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
              privat = ikyy.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
              ram2 = `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB`
...
🌹𝑰𝒕𝒔 𝑴𝒆 𝑭𝒂𝒓𝒊𝒅🌹`, imageMessage: imageMsg,
        ...
        case 'wibumenu':
        case  'menuwibu':
        ikyy.sendMessage(from, wibuMenu(prefix), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/1097e1c8ede9c2306e38c.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
        break
              groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
              privat = ikyy.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
              ram2 = `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB`
...
❦ ${prefix}nekopoisearch
 ...
 `
               ...
               buttons =  [
    {buttonId: `${prefix}rules`, buttonText: {displayText: 'Info🔎'}, type: 1},
]
               imageMsg = (await ikyy.prepareMessageMedia(fs.readFileSync(`./media/Menu.jpg`), 'imageMessage', { thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true }})).imageMessage
...
🌹𝑰𝒕𝒔 𝑴𝒆 𝑭𝒂𝒓𝒊𝒅🌹`, imageMessage: imageMsg,
       ...
       case 'downloadmenu':
        case  'menudownload':
        ikyy.sendMessage(from, downloadMenu(prefix), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/1097e1c8ede9c2306e38c.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
        break
              groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
              privat = ikyy.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
              ram2 = `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB`
...
❦ ${prefix}nhentaipdf *code*
 ...
 `
               ...
               buttons =  [
    {buttonId: `${prefix}donasi`, buttonText: {displayText: '𝐃𝐨𝐧𝐚𝐭𝐞💌'}, type: 1},
]
               imageMsg = (await ikyy.prepareMessageMedia(fs.readFileSync(`./media/Menu.jpg`), 'imageMessage', { thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true }})).imageMessage
...
🌹𝑰𝒕𝒔 𝑴𝒆 𝑭𝒂𝒓𝒊𝒅🌹`, imageMessage: imageMsg,
     ...
     case 'othermenu':
        case  'menuother':
        ikyy.sendMessage(from, otherMenu(prefix), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/6860ee8bc7798c072e0d7.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
        break
              groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
              privat = ikyy.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
              ram2 = `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB`
...
🌹𝑰𝒕𝒔 𝑴𝒆 𝑭𝒂𝒓𝒊𝒅🌹`, imageMessage: imageMsg,
        ...
        case 'gamemenu':
        case  'menugame':
        ikyy.sendMessage(from, gameMenu(prefix), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/6860ee8bc7798c072e0d7.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
        break
              groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
              privat = ikyy.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
              ram2 = `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB`
...
🌹𝑰𝒕𝒔 𝑴𝒆 𝑭𝒂𝒓𝒊𝒅🌹`, imageMessage: imageMsg,
               ...
               case 'stickermenu':
        case  'stikermenu':
        ikyy.sendMessage(from, stickerMenu(prefix), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/b30bee7fb97505854b55a.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
        break
              groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
              privat = ikyy.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
              ram2 = `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB`
...
🌹𝑰𝒕𝒔 𝑴𝒆 𝑭𝒂𝒓𝒊𝒅🌹`, imageMessage: imageMsg,
        ...
        case 'funmenu':
        case  'menufun':
        ikyy.sendMessage(from, funMenu(prefix), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/b30bee7fb97505854b55a.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
        break
              groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
              privat = ikyy.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
              ram2 = `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB`
...
❦ ${prefix}cekcantik
 ...
 🌹𝑰𝒕𝒔 𝑴𝒆 𝑭𝒂𝒓𝒊𝒅🌹`, imageMessage: imageMsg,
        ...
        case 'infomenu':
        case  'menuinfo':
        ikyy.sendMessage(from, infoMenu(prefix), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/6860ee8bc7798c072e0d7.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
        break
              groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
              privat = ikyy.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
              ram2 = `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB`
...
🌹𝑰𝒕𝒔 𝑴𝒆 𝑭𝒂𝒓𝒊𝒅🌹`, imageMessage: imageMsg,
      ...
      case 'rules':
             ikyy.sendMessage(from, `🌹 *Syarat & Ketentuan* 🌹\n1. Teks dan nama pengguna WhatsApp anda kami simpan di dalam server selama bot aktif.\n2. Data anda akan di hapus ketika bot offline.\n3. Kami tidak menyimpan gambar, video, file, audio, dan dokumen yang anda kirim.\n4. Kami tidak pernah meminta anda untuk memberikan informasi pribadi.\n5. Jika menemukan Bug/Error silahkan langsung lapor ke Owner bot.\n6. Cukup perintah 1x jika bot tidak merespon harap ulangi kembali, Jika di ulangi kembali tidak merespon, Bot tidak aktif\n7. Dilarang spam, Share virus virtex, Telpon, Video call, Kami akan blockir anda.\n8. Apapun yang anda perintah pada bot ini, *KAMI TIDAK BERTANGGUNG JAWAB!*\n\nOwner  BOTZ:\nwa.me/6285692949920\n\nTERIMA KASIH !~`, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `Hai Kak ${pushname}\n${ucapanWaktu}\n${time2}`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/b30bee7fb97505854b55a.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
             break
        ...
        case 'command':
               ...
               listmsg(from, `${ucapanWaktu}\nHai kak _${pushname}_ , Pilih Menu Pikaw Bot Disini `,
`
  ø${tanggal}              `, list)
               break
//------------------< Game >------------------- 
...
[ ${args[0]} ] Ketik Y/N untuk menerima atau menolak permainan`
               ...
               ikyy.sendMessage(from, starGame, text, {quoted: fgc, contextInfo: { mentionedJid: [sender, args[0].replace("@", "") + "@s.whatsapp.net"],}})
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
       ...
       case 'tebakanime':
              ...
              ikyy.sendMessage(from, ini_buffer, image, { quoted: fgc, caption: '*+* ```Tebak Anime```\n\n• *Petunjuk* :'+kisi_kisi+'\n• *Waktu* : 30s' }).then(() => {
       ...
       case 'tebaklagu':
              ...
              reply('*+* ```Tebak Lagu```\n\n• *Petunjuk* :'+kisi_kisi+'\n• *Waktu* : 30s')
              ikyy.sendMessage(from, ini_buffer, audio, {quoted: fgc}).then(() => {
       ...
       case 'kuismath':
              ...
              jawaban = get_result.jawaban
              ini_buffer = await getBuffer(ini_image)
              ikyy.sendMessage(from, ini_buffer, image, { quoted: fgc, caption: '*+* ```Kuis Matematika```\n\nSilahkan jawab soal berikut ini\n\n• *Waktu* : 50s' }).then(() => {
       ...
       case 'tebakgambar':
              ...
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              ini_buffer = await getBuffer(ini_image)
              ikyy.sendMessage(from, ini_buffer, image, { quoted: fgc, caption: 'Silahkan jawab soal berikut ini\n\nPetunjuk :'+kisi_kisi+'\nWaktu : 30s' }).then(() => {
...
*Pembelian Premium yang disertai SewaBot hanya akan membayar 20K (Diskon 5K)*`
              ikyy.sendMessage(from, await getBuffer(gopeynya), image, {quoted: fgc, caption: teksnya })
              break
//------------------< Sticker Cmd >-------------------
       case 'addcmd': 
       case 'setcmd':
              if (!isOwner) return  ikyy.sendMessage(from,(mess.only.owner), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              if (isQuotedSticker) {
              if (!q) return ikyy.sendMessage(from,(`Penggunaan : ${command} cmdnya dan tag stickernya`), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              var kodenya = mek.message.extendedTextMessage.contextInfo.quotedMessage.stickerMessage.fileSha256.toString('base64')
              addCmd(kodenya, q)
              ikyy.sendMessage(from,(" *🌹「 SUCCES 」🌹* "), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              } else {
              ikyy.sendMessage(from,('tag stickenya'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
}
              break
       case 'delcmd':
              if (!isOwner) return  ikyy.sendMessage(from,(mess.only.owner), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
...
_Silahkan tunggu file media sedang dikirim mungkin butuh beberapa menit_`
        ...
        case 'google':
              ...
              vars +=  `\n═════════════════\n\n*Judul:* ${results[i].title}\n\n*Deskripsi:* ${results[i].snippet}\n\n*Link:* ${results[i].link}\n\n`
               ...
               ikyy.sendMessage(from, ss, image, {caption: vars, quoted : fgc})
               }).catch(e => {
               console.log(e)
               reply(`${e}`)
})
...
_*Tunggu Proses Upload Media......*_`
       ...
       case 'tiktoknowm':
              ...
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: fgc})
              ikyy.relayWAMessage(prep)
  ...
  if (!isPremium) return reply(mess.only.premium)
      ...
      case 'tiktokaudio':
             ...
             ikyy.sendMessage(from, get_audio, audio, { mimetype: Mimetype.mp4Audio, quoted: fgc})
             break
      case 'fb':
      case 'facebook':
             if (!q) return
      ...
      case 'brainly':
             ...
             ikyy.sendMessage(from,(hmm), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
             console.log(res)
})
             break
      case 'ssweb':
             ...
             await ikyy.sendMessage(from, ini_buffer, image, { quoted: fgc})
             break
       case 'nhentaipdf':
             if (!isPremium) return reply(mess.only.premium)
             ...
             ikyy.sendMessage(from, ini_image, image, { caption: teks, quoted: fgc })
             anu = await fetchJson(`https://api.lolhuman.xyz/api/nhentaipdf/${henid}?apikey=${setting.lolkey}`)
             pdf = await getBuffer(anu.result)
             ikyy.sendMessage(from, pdf, document, { quoted: fgc, mimetype: Mimetype.pdf, filename: `${get_result.title_romaji}.pdf`, thumbnail: ini_image })
             } catch (e) {
             console.log(e)
             reply(String(e))
}
       ...
       case 'manga':
              ...
              await ikyy.sendMessage(from, thumbnail, image, { quoted: fgc, caption: ini_txt })
              break
       case 'doujindesu':
             if (!q) return reply(mess.wrongFormat)
             reply(mess.wait)
             ...
             ikyy.sendMessage(from, buffer, image, {caption: xixixai, quoted: fgc})
             } catch (e) {
             console.log(e)
             reply(String(e))
}
      ...
      case 'anime':
             ...
             ini_txt += `\nDescription : ${get_result.description}`
             thumbnail = await getBuffer(get_result.coverImage.large)
             await ikyy.sendMessage(from, thumbnail, image, { quoted: troli, caption: ini_txt })
             break
      case 'kusonime':
             if (args.length == 0) return reply(`Example: ${prefix + command} Gotoubun No Hanayome`)
             reply(mess.wait)
             ...
             await ikyy.sendMessage(from, ini_buffer, image, { quoted: troli, caption: ini_txt })
             break
       case 'otakudesu':
              if (args.length == 0) return reply(`Example: ${prefix + command} Gotoubun No Hanayome`)
              reply(mess.wait)
       ...
       case 'nekopoi':
              ...
              await ikyy.sendMessage(from, ini_buffer, image, { quoted: fgc, caption: ini_txt })
              break
       case 'nekopoisearch':
       ...
       case 'wallnime':
              ...
              ikyy.sendMessage(from, gambar, image, { quoted: fgc, thumbnail: Buffer.alloc(0), quoted: fgc, caption: '[ √ ] 𝚂𝚞𝚌𝚌𝚎𝚜𝚜...'})
})
              break
       ...
       reply(mess.wait)
              ...
              ikyy.sendMessage(from, gambar, image, { quoted: fgc,quoted: fgc, caption: '[ √ ] 𝚂𝚞𝚌𝚌𝚎𝚜𝚜...'})
}) 
              break
       case 'nakanoitsuki':
       case 'nakanoikyy':
       case 'nakanomiku':
              ...
              sendFileFromUrl(random, image, {quoted: fgc, thumbnail: Buffer.alloc(0), caption: `*Wangy²*`})
              break
       case 'storyanime':
              reply(mess.wait)
              anu = await fetchJson(`https://lolhuman.herokuapp.com/api/storynime?apikey=${setting.lolkey}`)
              buffer = await getBuffer(anu.result)
              ikyy.sendMessage(from, buffer, video, { quoted: fgc })
              break
       case 'nekopoi3d':
       case '3dnekopoi':
       case '3dnekopoilast':
       if (!isPremium) return reply(mess.only.premium)
        ...
        case 'otakuongoing':              
               ...
               ikyy.sendMessage(from, buff, image, {quoted: fgc, caption: ot})
               break
            case 'waifu':
...
break
    ...
    case 'play3':
		     ...
		     .then(res => {
    		  ikyy.sendMessage(from, '*Data berhasil didapatkan*\n\n_Silahkan tunggu, file media sedang dikirim mungkin butuh waktu beberapa menit_', text, { contextInfo: { externalAdReply: { title: res.data.result.title, body: 'Duration ' + res.data.result.duration + ', Size ' + res.data.result.size, thumbnailUrl: res.data.result.thumb, sourceUrl: res.data.result.link, quoted : fgc}}})
			  ikyy.sendMessage(from, { url: res.data.result.link }, 'audioMessage', { mimetype: 'audio/mp4', quoted: fgc, contextInfo: { externalAdReply: { title: res.data.result.title, mediaType: 2, thumbnailUrl: res.data.result.thumb, mediaUrl: res.data.result.source }}})
})
              break
        //case 'playy':
case 'lagu':
...
case 'play2':   
                ...
                reply(' 𝑾𝒂𝒊𝒕 𝑨 𝑴𝒊𝒏𝒖𝒕𝒆🍂, 𝒀𝒐𝒖𝒓 𝑹𝒆𝒒𝒖𝒆𝒔𝒕 𝑰𝒏 𝑷𝒓𝒐𝒄𝒆𝒔𝒔')
				play = args.join(" ")
...
*[Wait] Tunggu Sebentar..*`
				...
				ikyy.sendMessage(from, buffer1, video, {mimetype: 'video/mp4', filename: `${anu.result.video}.mp4`, quoted:fgc, caption: '[ √ ] 𝚂𝚞𝚌𝚌𝚎𝚜𝚜...'})
					break  
...
`
buttons = [{buttonId:`${prefix}play2 ${q}`,buttonText:{displayText:'🅥 VIDEO'},type:1},{buttonId:`${prefix}play3 ${q}`,buttonText:{displayText:'♬ AUDIO'},type:1}]
...
\`\`\`🌹 Link : ${get_data[i].url}\`\`\``
              ...
              ikyy.sendMessage(from, ini_buffer, image, { quoted: fgc, caption: teks })
              } catch {
...
\`\`\`🌹 Link : ${i.url}\`\`\``
       ...
       case 'img2url':
              ...
              .then(data => {
               ...
               ikyy.sendMessage(from, ibb, image, { quoted: fgc, caption: caps})
})
              .catch(err => {
               throw err
})
        ...
        case 'nulis':
        case 'tulis':
               if (args.length < 1) return ikyy.sendMessage(from,('Yang mau di tulis apaan?'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
               teks = args.join(' ')
               reply(mess.wait)
               ...
               ikyy.sendMessage(from, buff, image, {quoted: fgc, caption: mess.success}).catch(e => {
...
//------------------< Level >-------------------
      case 'level': 
              ...
              ikyy.sendMessage(from, buffer, image, { caption: teks, quoted: fgc})
              break
...
`
              ikyy.sendMessage(from, pp_tt, image, { quoted: fgc, caption: ini_txt, thumbnail: Buffer.alloc(0) })
              break
       case 'iguser':
              try {
...
//------------------< Sticker/Tools >-------------------
      ...
      case 'doge':
       ...
       case 'emoji':
              ...
              await ikyy.sendMessage(from, ini_buffer, sticker, { quoted: fgc })
              break
case 'ttp':
if (args.length < 1) return reply(`teksnya mana bruh?\ncontoh ${prefix} ${pushname}`)
woy = args.join(" ")
reply('📩 𝑫𝒂𝒕𝒂 𝑰𝒏 𝑷𝒓𝒐𝒄𝒆𝒔𝒔, 𝑷𝒍𝒆𝒂𝒔𝒆 𝑾𝒂??𝒕 𝑨 𝑴𝒊𝒏𝒖𝒕𝒆')
...
break
       case 'attp':
              ...
              ikyy.sendMessage(from, buffer, sticker, { quoted: fgc })
              break
       case 'ttg':
       ...
       case 'gifstiker':
            ...
            const media = await ikyy.downloadAndSaveMediaMessage(encmedia)
                ...
                .on('end', function () {
                console.log('Finish')
                ikyy.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: fgc})
                 fs.unlinkSync(media)
                fs.unlinkSync(ran)
                })
       ...
       case 'swm':
             ...
             .on('error', (e) => {
              console.log(e)
              ikyy.sendMessage(from, 'Terjadi kesalahan', 'conversation', { quoted: fgc})
              fs.unlinkSync(media)
})
             .on('end', () => {
            _out = getRandom('.webp')
             ...
             .on('exit', () => {
              ikyy.sendMessage(from, fs.readFileSync(_out),'stickerMessage', { quoted: fgc })
              fs.unlinkSync(out)
              fs.unlinkSync(_out)
              fs.unlinkSync(media)
})
      ...
      case 'toimg':
              ...
              ikyy.sendMessage(from, buffer, image, {quoted: fgc, caption: '[ √ ] 𝚂𝚞𝚌𝚌𝚎𝚜𝚜...'})
              fs.unlinkSync(ran)
})
              break
       case 'smeme': 
...
break
       ...
       case 'memegen':                    
        ...
        case 'tovideo':
               ...
               a = await webp2gifFile(mediaaa)
               mp4 = await getBuffer(a.result)
               ikyy.sendMessage(from, mp4, video, {mimetype: 'video/mp4', quoted: fgc, caption: mess.success})
               fs.unlinkSync(mediaaa)
               } else {
               reply(mess.wrongFormat)
}
        ...
        case 'tomp3':
               ...
               ikyy.sendMessage(from, buffer453, audio, { mimetype: 'audio/mp4', quoted: fgc })
               fs.unlinkSync(ran)
})
               } else {
               reply(mess.wrongFormat)
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ikyy.sendMessage(from,(` *Aktif selama ${runtime(process.uptime())}* `), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              break
       case 'donate': 
       case 'donasi':
       ikyy.sendMessage(from, (setting.txtDonasi), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/194a0b5963c1c5705d795.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
               break
       case 'sourcecode': 
       case 'sc': 
       case 'src':
       ikyy.sendMessage(from, `*🌹 SOURCE CODE🌹* :\nhttps://github.com/Faridrfauzi/Pikawbotv2`, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ᴘɪᴋᴀᴡ Bot🅥\n By©𝑭 𝑨 𝑹 𝒁 `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/6860ee8bc7798c072e0d7.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
       break
      case 'ping':
      case 'speed':
              timestampe = speed();
              latensie = speed() - timestampe
              ikyy.sendMessage(from, `「🌹 *𝙎𝙋𝙀𝙀𝘿 𝙏𝙀𝙎𝙏*🌹 」\nMerespon dalam ${latensie.toFixed(4)} Sec 💬`, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `Hai Kak ${pushname}👋🏻\n${ucapanWaktu}\n${time2} WIB`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/b30bee7fb97505854b55a.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              break
      case 'botstat':
              groups = ikyy.chats.array.filter(v => v.jid.endsWith('g.us'))
              privat = ikyy.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
...
\`\`\`🌹 Os Build Number: ${ikyy.user.phone.os_build_number}\`\`\``
             ikyy.sendMessage(from,(teks), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
             break  
//------------------< Owner >-------------------
      case 'addupdate':
             if (!isOwner) return reply(mess.only.owner)
      ...
      case 'exif':
             ...
             break	
      case 'join': 
             if (!q) return ikyy.sendMessage(from,('Linknya?'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
             if (!isOwner) return ikyy.sendMessage(from,(mess.only.owner), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
             if (!isUrl(args[0]) && !args[0].includes('https://chat.whatsapp.com/')) return reply('Linknya Invalid Tod')
             link = args[0].replace('https://chat.whatsapp.com/','')
             fak = ikyy.query({ json: ['action', 'invite', link],
             expect200: true })
             ikyy.sendMessage(from,('Berhasil Masuk Grup'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
             break
      case 'eval':
             try {
             if (!isOwner) return
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             ikyy.sendMessage(_.jid, bc, image, {quoted:fgc,caption: `*「 PESAN SIARAN BOT 」*\n\n${body.slice(4)}`})
}
...
//------------------< G R U P >-------------------
      case 'kick':
      if (!isGroupAdmins) return ikyy.sendMessage,(from,(mess.only.admin), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
      if (!isBotGroupAdmins) return ikyy.sendMessage(from,(mess.only.Badmin), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
             if (!isGroup) return reply(mess.only.group)
      ...
      case 'demote':
       ...
       case 'profile':
              ...
              ikyy.sendMessage(from, buff, image, {quoted: fgc, caption: profile})
              break
       case 'afk': 
              if (!isGroup) return reply(mess.only.group)
              if (isAfkOn) return ikyy.sendMessage(from,('Woe Kalo Mau Afk Jangan Nimbrung di sini'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              const reason = q ? q : 'Nothing.'
              afk.addAfkUser(sender, time, reason, _afk)
              const aluty = `Fitur AFK berhasil *diaktifkan!*\n\n➸ *Ussername*: ${pushname}\n➸ *Alasan*: ${reason}`
              ikyy.sendMessage(from,(aluty), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              break
       case 'infogrup':
       case 'infogrouup':
       case 'grupinfo':
       case 'groupinfo':
              ...
              ikyy.sendMessage(from, await getBuffer(pic), image, {quoted: fgc, caption: ingfo, contextInfo: {"mentionedJid": [groupMetadata.owner.replace('@c.us', '@s.whatsapp.net')]}})
              break
       case 'tagall':
       if (!isGroupAdmins) return ikyy.sendMessage(from,(mess.only.admin), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
...
if (!isOwner) return  reply(mess.only.owner)
  for (let i of groupMembers) {
      ...
      case 'sider':
             ...
             console.log(color(e))
             ikyy.sendMessage(from,('Reply chat bot!'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
}
             break
//------------------< Fun >-------------------
       case 'wangy':
       ...
       case 'toxic':
        ...
        case 'citacita':
              ...
              ikyy.sendMessage(from, cita2, audio,{mimetype: 'audio/mp4', ptt:true, quoted: fgc})
              break
       case 'apakah':
              apakah = body.slice(1)
       ...
       case 'dare':
              ...
              ikyy.sendMessage(from, buffer, image, { quoted: fgc, caption: '*Dare*\n\n'+ der })
              break		
       case 'jadian':
              jds = []
              jdii = groupMembers
...
//------------------< Lainnya >-------------------
        case 'getpp':
               ...
               ikyy.sendMessage(from, buffer, image, {caption: "[ √ ] 𝚂𝚞𝚌𝚌𝚎𝚜𝚜...", quoted: fgc })
               ...
               buffer = await getBuffer(linkpp)
               ikyy.sendMessage(from, buffer, image, { quoted: fgc, caption: `Profile Picture of @${mberr.split("@")[0]}`, contextInfo: { "mentionedJid": [mberr] }})
        ...
        case 'delete': // MR.CYSER
               try {
               if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return ikyy.sendMessage(from,('Reply chat bot'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
               ...
               break
        case 'tes':
        ikyy.sendMessage(from, ` *🌹「 BOT ONLINE 」🌹* `, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `Hai Kak ${pushname}👋🏻\n${ucapanWaktu}\n${time2}`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/d2349038a9d0191a0ccda.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted:fgc,quoted: fgc})
               break
...
│
└──「 *${botName}* 」`
             ikyy.sendMessage(from, await getBuffer(urlinfo), image, {quoted: fgc, caption: thankslort })
             break
case 'media':
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'cekapikey':
              ...
              ikyy.sendMessage(from, teks, text, {quoted: fgc})
              break
       case 'bugreport':
              if (args.length < 1) return reply(`Ketik ${prefix}bugreport [fiturnya] [Error Nya Gimana]`) 
              teks = args.join(' ')
              reply('Terima Kasih Telah Melaporkan Bug Pada Owner, Jika Itu Sekedar Iseng Maka Akan Di Ban Oleh Bot!')
              ikyy.sendMessage('6285692949920@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
       if (!isOwner) return  reply(mess.only.owner)
...
//------------------< Enable/Disable >-------------------
       ...
       if (!isGroupAdmins) return ikyy.sendMessage(from,(mess.only.admin), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              if (!isGroup) return reply(mess.only.group)
              if (ar[0] === 'enable') {
              if (isLevelingOn) return ikyy.sendMessage(from,(' *🌹「 LEVELING TELAH DI AKTIFKAN  SEBELUMNYA 」🌹* '), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/2608311a39195ccb41c00.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
            _leveling.push(from)
              fs.writeFileSync('./database/group/leveling.json', JSON.stringify(_leveling))
              ikyy.sendMessage(from,(' ```[ √ ] 𝚂𝚞𝚌𝚌𝚎𝚜𝚜... mengaktifkan leveling di group``` '), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              } else if (ar[0] === 'disable') {
              var anup = _leveling.indexOf(from)
            _leveling.splice(anup, 1)
              fs.writeFileSync('./database/group/leveling.json', JSON.stringify(_leveling))
              ikyy.sendMessage(from,(' ```[ √ ] 𝚂𝚞𝚌𝚌𝚎𝚜𝚜... menonaktifkan leveling di group```'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              } else {
              ikyy.sendMessage(from,('Pilih enable atau disable!'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
}
              break
       case 'antilink':
       if (!isGroupAdmins) return ikyy.sendMessage(from,(mess.only.admin), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
       if (!isGroup) return reply(mess.only.group)
              if (!isBotGroupAdmins) return ikyy.sendMessage(from, (` *🌹「 BOT NOT ADMIN 」🌹*`), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/2608311a39195ccb41c00.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              if (!q) return ikyy.sendMessage(from,(` *Pilih enable atau disable* `), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              if (args[0].toLowerCase() === 'enable'){
              if (isAntiLink) return ikyy.sendMessage(from, (` *🌹「 ANTILINK TELAH DI AKTIFKAN  SEBELUMNYA 」🌹* `), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/06c7522ade62731e26196.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              antilink.push(from)
              fs.writeFileSync('./database/group/antilink.json', JSON.stringify(antilink))
              ikyy.sendMessage(from,('*🌹「 ANTILINK DI AKTIFKAN 」🌹*\n\nYang Ngirim Link Group Bakal Ke Kick!'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/06c7522ade62731e26196.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              } else if (args[0].toLowerCase() === 'disable'){
              let anu = antilink.indexOf(from)
              antilink.splice(anu, 1)
              fs.writeFileSync('./database/group/antilink.json', JSON.stringify(antilink))
              ikyy.sendMessage(from,('*🌹「 ANTILINK DI NONAKTIFKAN 」🌹*'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/37b74113a00f2a53c4bd7.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
              } else {
              ikyy.sendMessage(from,(` *Pilih enable atau disable* `), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
}
              break
        ...
        if (!isGroupAdmins) return ikyy.sendMessage(from,(mess.only.admin), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
               if (!isGroup) return reply(mess.only.group)
               if (args.length < 1) return ikyy.sendMessage(from,('*🌹「 ! WELCOME  ENABLE/DISABLE 」🌹* \nExample = !welcome enable '), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/2608311a39195ccb41c00.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
               if ((args[0]) === 'enable') {
               if (isWelkom) return ikyy.sendMessage(from, (' *🌹「 WELCOME TELAH DI AKTIFKAN  SEBELUMNYA 」🌹* '), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/06c7522ade62731e26196.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
               welkom.push(from)
               fs.writeFileSync('./database/group/welcome.json', JSON.stringify(welkom))
               ikyy.sendMessage(from, (' ```[ √ ] 𝚂𝚞𝚌𝚌𝚎𝚜𝚜... mengaktifkan welcome di group```'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/23498fa9fe1a5ac4798cf.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
               } else if ((args[0]) === 'disable') {
               welkom.splice(from, 1)
               fs.writeFileSync('./database/group/welcome.json', JSON.stringify(welkom))
               ikyy.sendMessage(from, (' ```[ √ ] 𝚂𝚞𝚌𝚌𝚎𝚜𝚜... menonaktifkan welcome di group```'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/37b74113a00f2a53c4bd7.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
               } else {
               ikyy.sendMessage(from,('Enable untuk mengaktifkan, disable untuk menonaktifkan'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
               }
               break
        case 'mute':
        if (!isGroupAdmins) return ikyy.sendMessage(from,(mess.only.admin), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
               ...
               if (args[0].toLowerCase() === 'enable'){
               if (isMuted) return ikyy.sendMessage(from,(` *🌹「 GROUP TELAH DI MUTE 」🌹* `), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/925eb0fd7944a61036b2b.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
               mute.push(from)
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             ikyy.sendMessage(from, ` *🌹「 FOLLOW IG OWNER 」🌹* : https://www.instagram.com/faaaarr__/`, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `Hai Kak ${pushname}👋🏻\n${ucapanWaktu}\n${time2}`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/be275a73c34a73e704e1a.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
             break
      case 'ikyygroup':
             reply(' *🌹「 GROUP OFFICIAL BOT 」🌹*\n ==========================\nhttps://chat.whatsapp.com/ChDmgKcqXQV7EL9Pzgou8E\n========================== ')
             break
...
• Pemenangnya adalah [ @${winR} ] `
	   ikyy.sendMessage(from, starGame, text, {quoted: fgc, contextInfo: { mentionedJid: [winR + "@s.whatsapp.net", gelutSkuy.Z + "@s.whatsapp.net", gelutSkuy.Y + "@s.whatsapp.net",]}})
		fs.unlinkSync("./media/" + from + ".json");
...
Giliran = @${tty.player1.split('@')[0]}
  ...
  ikyy.sendMessage(from, ucapan, text, {quoted: fgc, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
  }
...
naa = ky_ttt.filter(toek => !toek.id.includes(from)) 
ky_ttt = naa
ikyy.sendMessage(from, `Yahh @${tty.player2.split('@')[0]} Menolak:(`,text,{quoted:fgc,contextInfo:{mentionedJid:[tty.player2]}})
}
}
...
${ttt}`
ikyy.sendMessage(from, ucapan1, text, {quoted: fgc, contextInfo:{mentionedJid: [tty.player1]}})
naa = ky_ttt.filter(hhg => !hhg.id.includes(from))
return ky_ttt = naa
}
...
${ttt}`
ikyy.sendMessage(from, ucapan1, text, {quoted:fgc, contextInfo:{mentionedJid: [tty.player2]}})
naa = ky_ttt.filter(hhg => !hhg.id.includes(from))
return ky_ttt = naa
}
...
ikyy.sendMessage(from, {text:teks, jpegThumbnail:fs.readFileSync('./media/wpmobile.png')}, 'extendedTextMessage', {sendEphemeral:true, quoted:fgc, contextInfo:{ forwardingScore:508, isForwarded:true, mentionedJid:[senderr]}})
}
	} 
